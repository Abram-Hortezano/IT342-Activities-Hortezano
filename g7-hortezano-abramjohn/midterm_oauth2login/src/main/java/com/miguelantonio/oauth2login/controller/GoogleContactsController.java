...
@Controller
class dwGoogleContactsController {

    private GooglePeopleService googlePeopleService;
    private OAuth2AuthorizedClientService authorizedClientService;

    public void GoogleContactsController(GooglePeopleService googlePeopleService, OAuth2AuthorizedClientService authorizedClientService) {
        this.googlePeopleService = googlePeopleService;
        this.authorizedClientService = authorizedClientService;
    }

    @gitGetMapping("/contacts")
